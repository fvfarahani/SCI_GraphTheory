...
corr_g1 = permute(cell2mat(struct2cell(load('/Volumes/Elements/SCI/fc/corr_sci_c.mat'))), [2 3 1]);
corr_g2 = permute(cell2mat(struct2cell(load('/Volumes/Elements/SCI/fc/corr_sci_t.mat'))), [2 3 1]);
...
cd '/Volumes/Elements/SCI/modularity_var/';           

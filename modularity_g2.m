...
% corr_all_g1 = permute(cell2mat(struct2cell(load('/Users/ismaila/Documents/C-Codes/SCI_GraphTheory/sci_data/SCI/fc/corr_hc.mat'))), [2 3 1]);
% corr_all_g2 = permute(cell2mat(struct2cell(load('/Users/ismaila/Documents/C-Codes/SCI_GraphTheory/sci_data/SCI/fc/corr_sci.mat'))), [2 3 1]);
...
% [S_g1,Q_g1] = iterated_genlouvain(B_g1,10000,0,1,[], PP_g1);
...
% [S_g2,Q_g2] = iterated_genlouvain(B_g2,10000,0,1,[], PP_g2);
